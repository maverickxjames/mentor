            ...
            <div class="o-sm-col-12">
                ...
                <div class="o-row o-container">
                    ...
                    <div
                        ...
                        <div>
                            <div id="subscribe" class="c-hs-form-wrap js-hs-form-wrap">
                                ...
                                <form method="POST" action="{{ route('subscribe.save') }}"
                                    ...
                                    <div class="upload-container">
                                        <div id="uploadArea3" class="upload-area">
                                            ...
                                            <button type="button" class="upload-button" id="browseButton3">Upload
                                                Profile
                                    ...
                                    <div class="upload-container">
                                        <div id="uploadArea" class="upload-area">
                                            ...
                                            <button type="button" class="upload-button" id="browseButton">Upload College
                                                ID
                                    ...
                                    <div class="upload-container">
                                        <div id="uploadArea2" class="upload-area">
                                            <input name="scoreproof" type="file" id="fileInput2" class="upload-input"
                                                style="display: none;" required />
                                            <button type="button" class="upload-button" id="browseButton2">Upload Score
                                                Card
                               ...
                               {{ $errors->has('subject_expert') ? 'has-error' : '' }}">
                                        <label for="subject_expert"> Subject Expert<span
                                    ...
                                    <div class="upload-container">
                                        <div id="uploadArea4" class="upload-area">
                                            <input name="video_clip" type="file" id="fileInput4" class="upload-input"
                                                style="display: none;" required />
                                            <button type="button" class="upload-button" id="browseButton4">Upload Video
                                                Clip
                                                <span style="color:red">*</span></button>
                                        </div>
                                    ...
                                    {{ $errors->has('video_clip') ? $errors->first('video_clip') : '' }}
                                     ...
                                     {{ $errors->has('password') ? 'has-error' : '' }}">
                                         <label for="password">Set Your Password <span style="color:red">*</span></label>
                                    ...
                                    {{ $errors->has('consent') ? 'has-error' : '' }}">
                                        ...
                                        <label for="consent" id="consent">
                                            ...
                                            I agree to the <a href="#0" target="_blank">terms and conditions</a> and <a
                                                href="#0" target="_blank">privacy policy</a>
                                        </label>
