<div class="o-row home-page-last-section-wrapper o-row--width-normal s-color-scheme">
    <div class="o-container o-container--width-normal o-container--width-same">
        <div
            class="o-sm-col-12 o-lg-col-offset-0 o-lg-col-5 o-md-col-offset-0 o-md-col-5 o-xs-col-11">
            ...
            <div class="c-headings-block u-font-size-extra-large">
                <div class="c-headings-block__tag">
                    JOIN OUR GLOBAL TEAM </div>
                <h2 class="gradient_color  c-headings-block__main h2">
                    Your Dream Job Awaits </h2>
                <div class=" u-font-size-extra-large c-headings-block__sub">
                    <p><span style="font-weight: 400;">We’re on an ongoing quest to find the
                            most ambitious, talented, and creative people to join our growing
                            team. We offer exciting opportunities across every stage of the
                            software development life cycle. In addition to a competitive salary
                            and benefits package, we provide flexible work options, career
                            advancement, and a global community of over 1,000 and
                            counting.</span></p>
                </div>
                <div class="c-learn-more-holder">
                    <div class="c-learn-more">
                        <a href="careers/jobs/" class="c-learn-more-link "></a>
